...
if run_button and topic.strip():
    ...
    # Refresh the sidebar now that this run's data is in the DB - without
    # this it would keep showing stats from before this run, which is
    # exactly the "total is less than this run's own cost" bug this fixes.
    render_stats(stats_container)
